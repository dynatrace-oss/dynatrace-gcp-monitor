...
def test_extraction_debug_text():
    actual_output = _create_dt_log_payload(LoggingContext("TEST"), json.dumps(debug_text_record))
    assert actual_output == debug_text_record_expected_output

def test_extraction_notice_json():
    actual_output = _create_dt_log_payload(LoggingContext("TEST"), json.dumps(notice_json_record))
    assert actual_output == notice_json_record_expected_output

def test_extraction_error_proto():
    actual_output = _create_dt_log_payload(LoggingContext("TEST"), json.dumps(error_proto_record))
