...
# Install kubectl.
curl -LO "https://dl.k8s.io/release/$(curl -L -s https://dl.k8s.io/release/stable.txt)/bin/linux/amd64/kubectl"  > /dev/null && chmod +x kubectl && sudo mv kubectl /usr/local/bin/kubectl

# Install helm.
wget https://get.helm.sh/helm-v3.5.3-linux-amd64.tar.gz > /dev/null
