...
testdata = [
    ...
    'cloud.gcp.apigee_googleapis_com.cassandra',
    'cloud.gcp.apigee_googleapis_com.server',
    'cloud.gcp.apigee_googleapis_com.udca',
    'cloud.gcp.apigee_googleapis_com.upstream',
    'cloud.gcp.istio_io.control',
    'cloud.gcp.istio_io.service.server',
    'cloud.gcp.kubernetes_io.nginx',
    'cloud.gcp.firebasestorage_googleapis_com.rules',
