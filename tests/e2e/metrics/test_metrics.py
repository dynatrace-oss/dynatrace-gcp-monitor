...
def test_metrics_on_dynatrace():
    print(f"Try to receive execution_count metric from Dynatrace in 10 min (start_time={os.environ['START_LOAD_GENERATION']} ,end_time={os.environ['END_LOAD_GENERATION']})")
    time.sleep(10*60)
