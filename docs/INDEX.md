...
|---|---|
| [ARCHITECTURE.md](ARCHITECTURE.md) | System architecture, tech stack, data flow, design decisions |
| [DEVELOPMENT.md](DEVELOPMENT.md) | Development environment setup, local run, testing, debugging |
| [k8s.md](k8s.md) | Kubernetes deployment architecture and troubleshooting links |
| [sfm_log.MD](sfm_log.MD) | Self-monitoring metrics for log forwarding |
| [HOT_RELOAD.md](HOT_RELOAD.md) | Hot-reload configuration guide — what can change without a pod restart |
