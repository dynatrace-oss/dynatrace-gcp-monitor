...
PROCESSING_WORKERS = get_int_environment_value("PROCESSING_WORKERS", 3)
CONCURRENT_REQUESTS = get_int_environment_value("CONCURRENT_REQUESTS", 3)
PARALLEL_PROCESSES = get_int_environment_value("PARALLEL_PROCESSES", 3)
...
REQUEST_BODY_MAX_SIZE = get_int_environment_value("DYNATRACE_LOG_INGEST_REQUEST_MAX_SIZE", 1048576) # 524288 / 1048576 2097152 4194304 5033164
