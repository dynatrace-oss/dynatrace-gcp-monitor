...
PROCESSING_WORKERS = get_int_environment_value("PROCESSING_WORKERS", 8)
...
REQUEST_BODY_MAX_SIZE = get_int_environment_value("DYNATRACE_LOG_INGEST_REQUEST_MAX_SIZE", 1048576) # 1048576 2097152 5033164
