...
PARALLEL_PROCESSES = get_int_environment_value("PARALLEL_PROCESSES", 2)
...
PROCESS_STARTUP_DELAY_SECONDS =  get_int_environment_value("PROCESS_STARTUP_DELAY_SECONDS", 15)
