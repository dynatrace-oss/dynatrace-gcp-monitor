...
# Prefer explicit LOGS_SUBSCRIPTION_PROJECT; fallback to GCP_PROJECT for backward compatibility
LOGS_SUBSCRIPTION_PROJECT = os.environ.get("LOGS_SUBSCRIPTION_PROJECT", os.environ.get("GCP_PROJECT", None))
