...
LOG_SELF_MONITORING_CONNECTIVITY_METRIC_TYPE = LOG_SELF_MONITORING_METRIC_PREFIX + "/connectivity_failures"
...
LOG_SELF_MONITORING_PUBLISH_TIME_FALLBACK_METRIC_TYPE = LOG_SELF_MONITORING_METRIC_PREFIX + "/publish_time_fallback"
...
LOG_SELF_MONITORING_PULLING_TIME_SIZE_METRIC_TYPE = LOG_SELF_MONITORING_METRIC_PREFIX + "/pulling_time"
LOG_SELF_MONITORING_LOG_INGEST_PAYLOAD_SIZE_METRIC_TYPE = LOG_SELF_MONITORING_METRIC_PREFIX + "/log_ingest_payload_size"
LOG_SELF_MONITORING_RAW_LOG_INGEST_PAYLOAD_SIZE_METRIC_TYPE = LOG_SELF_MONITORING_METRIC_PREFIX + "/raw_log_ingest_payload_size"
LOG_SELF_MONITORING_PULLED_LOGS_ENTRIES_METRIC_TYPE = LOG_SELF_MONITORING_METRIC_PREFIX + "/pulled_logs_entries"
...
LOG_SELF_MONITORING_PUBLISH_TIME_FALLBACK_METRIC_DESCRIPTOR = {
    "type": LOG_SELF_MONITORING_PUBLISH_TIME_FALLBACK_METRIC_TYPE,
    "valueType": "INT64",
    "metricKind": "GAUGE",
    "description": "Number of records without timestamp, timestamped with Pub/Sub publish time",
    "displayName": "Dynatrace Log Integration publish time fallback",
    "unit": "1",
    "monitoredResourceTypes": ["generic_task"],
    "labels": [
        DYNATRACE_TENANT_URL_LABEL_DESCRIPTOR,
...
LOG_SELF_MONITORING_PULLING_TIME_SIZE_METRIC_DESCRIPTOR = {
...
LOG_SELF_MONITORING_RAW_LOG_INGEST_PAYLOAD_SIZE_METRIC_DESCRIPTOR = {
    "type": LOG_SELF_MONITORING_RAW_LOG_INGEST_PAYLOAD_SIZE_METRIC_TYPE,
    "valueType": "DOUBLE",
    "metricKind": "GAUGE",
    "description": "Raw log ingest payload size",
    "displayName": "Dynatrace Log Integration raw (uncompressed) log ingest payload size",
    "unit": "kBy",
    "monitoredResourceTypes": ["generic_task"],
    "labels": [
        DYNATRACE_TENANT_URL_LABEL_DESCRIPTOR,
...
LOG_SELF_MONITORING_PULLED_LOGS_ENTRIES_METRIC_DESCRIPTOR = {
    "type": LOG_SELF_MONITORING_PULLED_LOGS_ENTRIES_METRIC_TYPE,
    "valueType": "INT64",
    "metricKind": "GAUGE",
    "description": "Number of log entries pulled from GCP Pub/Sub",
    "displayName": "Dynatrace Log Integration number of pulled logs entries",
    "unit": "1",
    "monitoredResourceTypes": ["generic_task"],
    "labels": [
        DYNATRACE_TENANT_URL_LABEL_DESCRIPTOR,
...
LOG_SELF_MONITORING_ACK_FAILURES_METRIC_DESCRIPTOR = {
    "type": LOG_SELF_MONITORING_ACK_FAILURES_METRIC_TYPE,
    "valueType": "INT64",
    "metricKind": "GAUGE",
    "description": "Number of failed Pub/Sub message acknowledgements (may cause duplicates)",
    "displayName": "Dynatrace Log Integration ACK failures",
    "unit": "1",
    "monitoredResourceTypes": ["generic_task"],
    "labels": [
        DYNATRACE_TENANT_URL_LABEL_DESCRIPTOR,
...
LOG_SELF_MONITORING_ACK_SUCCEEDED_METRIC_DESCRIPTOR = {
    "type": LOG_SELF_MONITORING_ACK_SUCCEEDED_METRIC_TYPE,
    "valueType": "INT64",
    "metricKind": "GAUGE",
    "description": "Number of successfully acknowledged Pub/Sub messages",
    "displayName": "Dynatrace Log Integration ACK succeeded",
    "unit": "1",
    "monitoredResourceTypes": ["generic_task"],
    "labels": [
        DYNATRACE_TENANT_URL_LABEL_DESCRIPTOR,
...
LOG_SELF_MONITORING_ACK_BACKLOG_METRIC_DESCRIPTOR = {
    "type": LOG_SELF_MONITORING_ACK_BACKLOG_METRIC_TYPE,
    "valueType": "INT64",
    "metricKind": "GAUGE",
    "description": "Number of pending Pub/Sub ACK tasks (backlog)",
    "displayName": "Dynatrace Log Integration ACK backlog",
    "unit": "1",
    "monitoredResourceTypes": ["generic_task"],
    "labels": [
        DYNATRACE_TENANT_URL_LABEL_DESCRIPTOR,
...
LOG_SELF_MONITORING_METRIC_MAP = {
    ...
    LOG_SELF_MONITORING_PUBLISH_TIME_FALLBACK_METRIC_TYPE: LOG_SELF_MONITORING_PUBLISH_TIME_FALLBACK_METRIC_DESCRIPTOR,
    ...
    LOG_SELF_MONITORING_PULLING_TIME_SIZE_METRIC_TYPE : LOG_SELF_MONITORING_PULLING_TIME_SIZE_METRIC_DESCRIPTOR,
    LOG_SELF_MONITORING_LOG_INGEST_PAYLOAD_SIZE_METRIC_TYPE: LOG_SELF_MONITORING_LOG_INGEST_PAYLOAD_SIZE_METRIC_DESCRIPTOR,
    LOG_SELF_MONITORING_RAW_LOG_INGEST_PAYLOAD_SIZE_METRIC_TYPE : LOG_SELF_MONITORING_RAW_LOG_INGEST_PAYLOAD_SIZE_METRIC_DESCRIPTOR,
    LOG_SELF_MONITORING_PULLED_LOGS_ENTRIES_METRIC_TYPE: LOG_SELF_MONITORING_PULLED_LOGS_ENTRIES_METRIC_DESCRIPTOR,
