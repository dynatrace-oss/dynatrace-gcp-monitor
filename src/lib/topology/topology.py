...
def choose_services_for_topology_fetch(
    ...
    context.log(project_id, f"Services chosen for topology fetch: [{msg_chosen_services}];"
                            f" skipped services (disabled APIs): [{msg_disabled_topology_services}]; "
                            f" skipped services (no extractors): [{msg_no_extractor_services}]")
