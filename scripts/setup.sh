...
METRIC_AUTODISCOVERY=$("$YQ" e '.googleCloud.common.metricAutodiscovery' $FUNCTION_ACTIVATION_CONFIG)
readonly METRIC_AUTODISCOVERY
...
METRIC_AUTODISCOVERY: '$METRIC_AUTODISCOVERY'
USE_PROXY: '$USE_PROXY'
